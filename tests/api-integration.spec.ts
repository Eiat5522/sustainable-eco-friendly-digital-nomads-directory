...
test.describe("API Integration Testing - Workstream E.1", () => {
  ...
  test.describe("User Dashboard Endpoints - Task 5.6 Validation", () => {
    ...
    test("GET /api/user/dashboard - Get Dashboard Data", async ({
      request,
    }) => {
    ...
    test("GET /api/user/favorites - Get User Favorites", async ({
      request,
    }) => {
    ...
    test("DELETE /api/user/favorites/[listingId] - Remove from Favorites", async ({
      request,
    }) => {
      const listingId = "test-listing-id";
      const response = await request.delete(
        `${BASE_URL}/api/user/favorites/${listingId}`,
        {
          headers: {
            Authorization: `Bearer ${authToken}`,
            Cookie: "next-auth.session-token=" + authToken,
    ...
    test("GET /api/user/preferences - Get User Preferences", async ({
      request,
    }) => {
    ...
    test("PUT /api/user/preferences - Update User Preferences", async ({
      request,
    }) => {
    ...
    test("GET /api/user/analytics - Get User Analytics", async ({
      request,
    }) => {
      const response = await request.get(
        `${BASE_URL}/api/user/analytics?timeRange=30d`,
        {
          headers: {
            Authorization: `Bearer ${authToken}`,
            Cookie: "next-auth.session-token=" + authToken,
    ...
    test("POST /api/user/analytics - Track User Analytics", async ({
      request,
    }) => {
      const analyticsData = {
        event: "listing_view",
  ...
  test.describe("Listings Endpoints", () => {
    ...
    test("GET /api/listings?city=Bangkok - Filter by City", async ({
      request,
    }) => {
      const response = await request.get(
        `${BASE_URL}/api/listings?city=Bangkok`
      );
    ...
    test("GET /api/listings/[slug] - Get Listing Details", async ({
      request,
    }) => {
      // First get a listing to test with
      const listingsResponse = await request.get(
        `${BASE_URL}/api/listings?limit=1`
      );
  ...
  test.describe("Contact Form Endpoint", () => {
    ...
    test("POST /api/contact - Invalid Email Validation", async ({
      request,
    }) => {
  ...
  test.describe("Blog Endpoints", () => {
    ...
    test("GET /api/blog/[slug] - Get Blog Post Details", async ({
      request,
    }) => {
