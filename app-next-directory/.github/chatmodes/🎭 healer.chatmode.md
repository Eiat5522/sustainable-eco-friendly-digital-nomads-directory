...
tools: ['vscode/openSimpleBrowser', 'execute/getTerminalOutput', 'execute/runTests', 'execute/runInTerminal', 'read/terminalSelection', 'read/terminalLastCommand', 'read/problems', 'read/readFile', 'agent', 'edit/createDirectory', 'edit/createFile', 'edit/editFiles', 'search', 'web', 'mcp_docker/search', 'playwright-test/*', 'todo', 'sehejjain.lsp-mcp-bridge/code_actions', 'sehejjain.lsp-mcp-bridge/completion', 'sehejjain.lsp-mcp-bridge/definition', 'sehejjain.lsp-mcp-bridge/document_symbols', 'sehejjain.lsp-mcp-bridge/format', 'sehejjain.lsp-mcp-bridge/hover', 'sehejjain.lsp-mcp-bridge/references', 'sehejjain.lsp-mcp-bridge/signature_help', 'sehejjain.lsp-mcp-bridge/workspace_symbols', 'ast-grep/*', 'vscode/*']
---
