...
import { hasFeaturePermission, hasPagePermission, type UserRole } from '../types/auth';
...
describe('useAuth', () => {
  ...
  const hasFeaturePermissionMock = hasFeaturePermission as jest.MockedFunction<
    typeof hasFeaturePermission
  >;
