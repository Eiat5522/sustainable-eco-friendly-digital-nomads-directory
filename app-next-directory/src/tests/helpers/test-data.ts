...
const ecoTags: TestEcoTag[] = [
  {
    ...
    description:
      'Businesses that have adopted strong waste reduction and circular economy practices.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Invests in water conservation through greywater systems, filtration and guest education.',
  },
  {
    _id: 'eco-community',
    ...
    description:
      'Partners with local organisations and artisans to give back to the neighbourhood.',
  },
];
...
const listings: Listing[] = [
    ...
    coworkingDetails: {
      ...
      pricingPlans: [
        { name: 'Day Pass', price: 20, duration: 'day', features: ['Hot desk', 'Coffee & tea'] },
        {
          ...
          price: 180,
          duration: 'month',
          features: ['Dedicated desk', 'Locker', '5 meeting credits'],
        },
      ],
  ...
  },
  {
    ...
    accommodationDetails: {
      ...
      specificAmenitiesAccommodation: [
        'Greywater irrigation',
        'Community kitchen',
        'Rooftop solar lounge',
      ],
    },
  },
];
...
const cities: TestCity[] = [
  {
    ...
    country: 'Thailand',
    description:
      'Vibrant Thai capital embracing green transit, creative reuse and solar innovation.',
    heroImage: 'https://images.test/bangkok.jpg',
    coordinates: { lat: 13.7563, lng: 100.5018 },
    sustainabilityScore: 78,
    highlights: [
      'Extensive BTS/MRT network',
      'Innovative circular startups',
      'Community-led river cleanups',
    ],
  ...
  },
  {
    ...
    country: 'Thailand',
    description:
      'Mountain city with slow travel vibes, organic food networks and creative makerspaces.',
    heroImage: 'https://images.test/chiang-mai.jpg',
    coordinates: { lat: 18.7883, lng: 98.9853 },
    sustainabilityScore: 84,
    highlights: [
      'Zero-waste cafes & refill culture',
      'Community composting hubs',
      'Cycling friendly old town',
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      'Ocean-positive innovation labs',
      'Car-free neighbourhood pilots',
    ],
...
const reviews: AppReview[] = [
  {
    ...
    rating: 5,
    comment:
      'Loved the rooftop garden and the events calendar – perfect for meeting other nomads focused on climate.',
  ...
  },
  {
    ...
    rating: 4,
    comment:
      'Great equipment and super friendly staff. The circular design tours were inspirational!',
