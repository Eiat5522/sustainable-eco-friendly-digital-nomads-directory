...
export function HeroSection() {
  return (
    <section className="relative min-h-[600px] bg-gradient-to-br from-neo-primary via-blue-600 to-blue-800 overflow-hidden">
      {/* Geometric Shapes */}
      <div className="absolute top-20 left-20 w-32 h-32 bg-neo-secondary rounded-full opacity-80">
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="body-lg text-blue-100 mb-12 max-w-2xl mx-auto">
            The growing source for all sustainable venues is empowered by the community to ensure you will 
            get the most eco-friendly spaces for your digital nomad journey.
          </p>

          {/* Search Bar */}
          <div className="relative max-w-2xl mx-auto mb-8">
            <div className="relative">
              <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 text-neo-text-secondary" size={20} />
              <NeoInput
                placeholder="Search +3200 sustainable venues"
              ...
              <button className="absolute right-4 top-1/2 transform -translate-y-1/2 p-2 hover:bg-gray-100 rounded-lg transition-colors">
                <Mic className="text-neo-text-secondary" size={20} />
              </button>
            </div>
          </div>
        </div>
