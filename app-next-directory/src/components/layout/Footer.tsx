          ...
          <div>
            ...
            <div className="flex space-x-4 mt-6">
              <Link href="#" className="text-white/80 hover:text-white transition-colors">
                ...
                <svg className="icon w-5 h-5" fill="currentColor" viewBox="0 0 24 24">              <Link href="#" className="text-white/80 hover:text-white transition-colors">
                <span className="sr-only">Twitter</span>
                <svg className="icon" className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                <svg className="icon" className="w-5 h-5 text-white/90 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
                </svg>
                <svg className="icon w-5 h-5 text-white/90 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">                  Bangkok 10110, Thailand
                <svg className="icon w-5 h-5 text-white/90 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">              </div>
              <div className="flex items-center space-x-3">
                <svg className="icon" className="w-5 h-5 text-white/90 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
