		...
		<section className="py-20 bg-gray-50 dark:bg-gray-800">
			<div className="container mx-auto px-4">
				<div className="text-center max-w-3xl mx-auto mb-16">
					...
					>
						Discover sustainable cities that welcome digital nomads with
						eco-conscious accommodations and workspaces.
					</motion.p>
				</div>
									...
									<div className="p-4">
										<div className="flex justify-between items-center">
											...
											<div className="text-green-600 dark:text-green-400 text-sm font-medium group-hover:underline transition-all duration-300">
												...
												<svg
													xmlns="http://www.w3.org/2000/svg"
													className="h-4 w-4 inline ml-1 transform group-hover:translate-x-1 transition-transform"
													viewBox="0 0 20 20"
													fill="currentColor"
												>
													<path
