...
export function AboutSection() {
  return (
    <section id="about" aria-labelledby="about-heading" className="py-20 bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {features.map((feature) => {
            ...
            return (
              <NeoCard key={feature.title} variant="elevated" className="text-center group hover:shadow-[12px_12px_0px_0px] transition-all duration-300">
          ...
          <NeoCard variant="elevated" className="inline-block p-8 bg-gradient-to-r from-neo-primary to-blue-600 text-white">
            <NeoCardContent>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="/about" className="neo-button neo-button-hover inline-flex items-center justify-center whitespace-nowrap rounded-lg font-bold transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/80 h-14 px-8 py-4 text-lg bg-transparent text-neo-text-primary hover:bg-neo-text-primary hover:text-neo-surface border-white/80 border">
                  Learn More
                </Link>
              </div>
            </NeoCardContent>
