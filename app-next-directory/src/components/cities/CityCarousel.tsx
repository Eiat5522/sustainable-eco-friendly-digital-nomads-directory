...
interface EcoCityCarouselProps {
  title?: string;
  description?: string;
  cities: EcoCityItem[];
}

const EcoCityCarousel = ({
  title = "Eco-Friendly Destinations",
  description = "Discover sustainable cities that are leading the way in eco-friendly initiatives and digital nomad communities.",
  cities = [
    {
      id: "chiang-mai",
      name: "Chiang Mai, Thailand",
      sustainabilityScore: 85,
      highlights: ["Green Coworking Spaces", "Organic Markets", "Bike-Friendly Streets"],
      image: "/images/cities/chiang-mai.jpg",
    },
    {
      id: "bangkok",
      name: "Bangkok, Thailand",
      sustainabilityScore: 82,
      highlights: ["Solar-Powered Offices", "Zero-Waste Cafes", "Green Transport"],
    ...
    },
    {
      ...
      highlights: ["Eco Resorts", "Marine Conservation", "Clean Energy"],
      image: "/images/cities/phuket.jpg",
    },
    {
      id: "koh-phangan",
      name: "Koh Phangan, Thailand",
      sustainabilityScore: 90,
      highlights: ["Off-Grid Living", "Sustainable Tourism", "Beach Cleanups"],
      image: "/images/cities/koh-phangan.jpg",
    },
    {
      id: "chiang-rai",
      name: "Chiang Rai, Thailand",
      sustainabilityScore: 87,
      highlights: ["Eco Agriculture", "Natural Buildings", "Community Projects"],
      image: "/images/cities/chiang-rai.jpg",
    },
  ],
}: EcoCityCarouselProps) => {
      ...
      <div className="container mx-auto">
        <div className="mb-8 flex items-end justify-between md:mb-14 lg:mb-16">
          <div className="flex flex-col gap-4">
            ...
            <p className="max-w-lg text-green-700/80">{description}</p>
          </div>
