    ...
    <div className={`relative ${className}`}>
      ...
      {ecoView && (
        <div className="absolute top-4 right-4 bg-primary-500/90 text-white px-3 py-1.5 rounded-full text-xs font-medium shadow-lg z-10 flex items-center">
          <svg className="icon mr-1.5" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
            <path d="M17,8C8,10 5.9,16.17 3.82,21.34L5.71,22L6.66,19.7C7.14,19.87 7.64,20 8,20C19,20 22,3 22,3C21,5 14,5.25 9,6.25C4,7.25 2,11.5 2,13.5 2,15.5 3.75,17.25 3.75,17.25C7,8 17,8 17,8Z" />
          </svg>          Eco View
        </div>
      )}
    </div>
