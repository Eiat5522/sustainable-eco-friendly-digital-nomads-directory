...
jest.mock('@/components/ui/neo-button', () => ({
  NeoButton: function MockNeoButton({ children, onClick, ...props }: any) {
    return (
...
jest.mock('@/components/ui/neo-card', () => ({
  NeoCard: function MockNeoCard({ children, ...props }: any) {
    return <div data-testid="neo-card" {...props}>{children}</div>
  },
  ...
  NeoCardContent: function MockNeoCardContent({ children, className }: any) {
    return <div data-testid="neo-card-content" className={className}>{children}</div>
  },
}))
...
describe('DigitalNomadSearchFilter', () => {
  ...
  describe('Active Filters Display', () => {
    ...
    it('should show unchecked state for inactive filters', () => {
      ...
      const coworkingCheckbox = screen.getByLabelText('Category: Coworking Space') as HTMLInputElement
