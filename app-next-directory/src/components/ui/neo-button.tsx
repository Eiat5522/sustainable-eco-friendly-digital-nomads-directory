...
const NeoButton = React.forwardRef<HTMLButtonElement, NeoButtonProps>(
  ({ className, variant = 'primary', size = 'md', asChild = false, ...props }, ref) => {
    ...
    const baseClasses =
      'neo-button neo-button-hover inline-flex items-center justify-center whitespace-nowrap rounded-lg font-bold transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50';
    ...
    const variants = {
      ...
      outline:
        'bg-transparent text-neo-text-primary hover:bg-neo-text-primary hover:text-neo-surface',
    };
