...
describe('SectionHeader', () => {
  ...
  describe('Content Variations', () => {
    ...
    it('handles long description', () => {
      const longDescription = 'This is a very long description that should be properly constrained by the max-w-2xl class and centered with mx-auto. It should wrap to multiple lines if needed.';
      render(
        <SectionHeader 
          title="Title" 
    ...
    it('handles special characters in title', () => {
      ...
      expect(screen.getByRole('heading', { level: 2 })).toHaveTextContent('Special & Characters <>');
    });
