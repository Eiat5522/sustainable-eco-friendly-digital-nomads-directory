...
/**
 * Manually trigger cleanup of expired rate limit entries.
 * Primarily used for testing or when the background interval is not running.
 */
...
// Use undefined initially so that the lazy initializer runs at least once.
let redis: Redis | null | undefined;

/**
 * Resets the cached Redis client. Used for testing.
 */
