...
/**
 * Manually trigger the cleanup of expired entries in the rate limit store.
 * Primarily used for unit testing the cleanup logic.
 */
 ...
 * Primarily used for unit testing to force re-initialization.
 */
