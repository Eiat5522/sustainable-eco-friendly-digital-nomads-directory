      ...
      <div className="min-h-screen flex items-center justify-center bg-background p-6">
        <div className="w-full max-w-md border-4 border-black rounded-xl bg-white p-6 shadow-[12px_12px_0_0_rgba(0,0,0,1)]">
          ...
          <div className="mt-6 flex items-center justify-between text-sm">
            {authMode === 'admin' ? (
              <Link className="text-blue-600 underline" href="/auth/signup">Back to regular login</Link>
            ) : (
              <Link className="text-blue-600 underline" href="/auth/reset-request">Forgot password?</Link>
            )}
            <Link className="text-blue-600 underline" href="/auth/signup?admin=true">Admin access</Link>
          </div>
        </div>
      </div>
      <Footer />
