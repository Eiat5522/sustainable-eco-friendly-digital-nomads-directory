        ...
        <div className="flex w-full flex-col justify-center bg-neo-success border-b-4 md:border-b-0 md:border-r-4 border-neo-border p-6 md:w-auto md:flex-1 md:p-8 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="font-bold text-neo-border text-sm uppercase tracking-[0.2em]">
                EcoNomad
              </span>
            </div>
            <h2 className="heading-xl text-neo-border uppercase tracking-tight mb-4">
              Create your
              <br />
              account
            </h2>
            ...
            <div className="border-2 border-neo-border bg-neo-surface p-5 shadow-[4px_4px_0px_0px] shadow-neo-shadow">
              <h3 className="text-xs font-bold uppercase tracking-[0.15em] mb-4 text-neo-text-primary">
                Quick Sign In
              </h3>
              <SocialAuthRow />
            </div>
