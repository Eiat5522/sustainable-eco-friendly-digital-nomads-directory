...
export default function TestGalleryPage() {
  ...
  const manyImages = Array.from(
    { length: 12 },
    (_, i) => `https://picsum.photos/seed/${i + 4}/400/300`
  );
        ...
        <div className="space-y-12">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">
              Gallery with Many Images (12 images) - Testing Overlap Issue
            </h2>
          ...
          <section className="bg-blue-50 p-8 rounded-lg border-2 border-blue-200">
            ...
            <p className="text-blue-700">
              This component is placed below the gallery to test if the gallery images overlap with
              it. If you can see this text clearly without any overlap, the gallery is working
              correctly. If this text is covered or partially hidden by gallery images, then we have
              the overlap issue mentioned in the problem statement.
            </p>
