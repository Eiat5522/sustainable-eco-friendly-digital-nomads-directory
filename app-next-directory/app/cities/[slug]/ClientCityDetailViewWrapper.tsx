...
const DynamicCityDetailView = dynamic(() => import('@/components/city/CityDetailView').then(mod => mod.CityDetailView), {
  ssr: false,
...
export default function ClientCityDetailViewWrapper({ city, listings }: ClientCityDetailViewWrapperProps) {
