...
describe('Manage Listings API', () => {
  ...
  describe('PUT /api/listings/manage/[id]', () => {
    describe('Successful Requests', () => {
      ...
      it('should update listing with detail objects', async () => {
        const existingListing = {
          _id: 'listing-1',
          owner: { _ref: 'user-1' },
        };
        ...
        const request = new Request('http://localhost/api/listings/manage/listing-1', {
          ...
          body: JSON.stringify({
            ...
            accommodationDetails: {
              ...
              pricePerNightThbRange: { min: 1000, max: 2000 },
            },
            cafeDetails: {
      ...
      it('should update listing with image fields', async () => {
        const existingListing = {
          _id: 'listing-1',
          owner: { _ref: 'user-1' },
        };
